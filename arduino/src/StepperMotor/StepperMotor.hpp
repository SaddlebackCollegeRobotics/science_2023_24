...
public:
    ...
    StepperMotor(pins::pin_t dir_pin, pins::pin_t step_pin, pins::pin_t enable_pin, uint32_t steps_per_rev, uint32_t step_period_millis = 2);
