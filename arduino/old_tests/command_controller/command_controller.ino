...
void instruction_handle() {
  ...
  switch(bytes_0) {
    ...
    case PUMP_8:
      switch(bytes_1) {
        case 0:
          arg_t val = {(unsigned int)((((unsigned int)transmission_in[3]) << 24) |
                      (((unsigned int)transmission_in[4]) << 16) |
                      (((unsigned int)transmission_in[5]) << 8)  |
                      ((unsigned int)transmission_in[6]))};
